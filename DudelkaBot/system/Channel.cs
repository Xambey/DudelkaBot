                        ...
                        case TypeMessage.PRIVMSG:
                            ...
                            switch (msg.Command)
                            {
                                ...
                                case Command.counter:
                                    ...
                                    if (chCounter.Moderator || msg.UserName == "dudelka_krasnaya" || msg.UserName == Name)
                                    {
                                        ...
                                        if (string.IsNullOrEmpty(msg.Sign))
                                        {
                                            ...
                                            if (j.Success)
                                            {
                                                SendWhisperMessage(j.Groups["id"].Value, msg.UserName, counters.Select(a => a.Counter_name + " = " + a.Count.ToString()).ToList());
                                                break;
                                            }
                                        }
                                ...
                                case Command.existedcounter:
                                    ...
                                    if (chexCounter == null)
                                        break;
                                    if (chexCounter.Moderator || msg.UserName == "dudelka_krasnaya" || msg.UserName == "eduardo3187" || msg.UserName == Name)
                                    {
                                        var channel = db.Channels.FirstOrDefault(a => a.Channel_name == msg.Channel);
                                        if (channel == null)
                                            break;
